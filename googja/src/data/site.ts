...
/** 無限脳 の実画面（公開中のWeb版から撮影・端末幅402px・他社広告は遮断。
    進捗まわりはストア素材と同じくデモ用の記録を入れた状態で撮っている）。
...
export const shots: Shot[] = [
	...
	},
	{
		...
		caption: '結果とメダル判定',
		alt: '無限脳の結果画面。10問中10問正解で金メダル、最高連続正解の数が表示されている。',
	},
	{
		no: '04',
		src: '/works/brain-infinity/04-frontier.webp',
		caption: 'ニューラル・フロンティア',
		alt: '無限脳のフロンティア画面。カテゴリを惑星として航路で結び、到達レベルと航路シグナルの点灯数を表示している。',
	},
	{
		no: '05',
		src: '/works/brain-infinity/05-calendar.webp',
		caption: 'プレイカレンダーと連続記録',
		alt: '無限脳のプレイカレンダー画面。連続記録とプレイ日数、月別のカレンダーに実施日が印されている。',
	},
	{
		no: '06',
	...
	},
	{
		...
		alt: '無限脳の設定画面。言語と名前、効果音と音楽、アクセシビリティへの導線、生まれた年と利用状況データの送信が並んでいる。',
	},
	{
		no: '09',
