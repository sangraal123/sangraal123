...
lesson:
  prerequisite: "Expoアプリが実機で起動する"
  output: "仕様に対応した画面骨格とルーティング"
  completion: "一覧・作成・詳細の画面へ移動し、戻る操作も確認する"
  environment: "Node.js・Git・Expo Go対応のMVP・スマートフォン"
  effort: "60〜120分"
  cost: "AIの利用枠による。最初の実機起動にストア登録は不要"
---
